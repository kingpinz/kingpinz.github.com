...
//获取时间的事件
	...
	function time(){
		...
		var str2=toDou(parseInt(h))+'-'+toDou(parseInt(f))+'-'+toDou(parseInt(s))+'-'+parseInt(w);
		var arr=['images/seven.png','images/one.png','images/two.png','images/third.png','images/four.png','images/five.png','images/six.png',]
		
		for(var i=0;i<aImg1.length;i++){
			if(aImg1[i].className=='num'){
		...
		for(var i=0;i<aImg2.length;i++){
			...
			if(aImg2[i].className=='num2'){
				aImg2[aImg2.length-1].src=arr[w];
			}
		}
	}
